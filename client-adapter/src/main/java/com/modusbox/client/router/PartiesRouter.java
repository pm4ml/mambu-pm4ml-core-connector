	...
	public void configure() {
		...
		from("direct:getClientById")
				...
				.to("bean:customJsonMessage?method=logJsonMessage('info', ${header.X-CorrelationId}, " +
						...
						"'Request sent to, GET https://{{easy.mambu.host}}/clients/${header.idValueTrimmed}')")
				.toD("https://{{easy.mambu.host}}/clients/${header.idValueTrimmed}")
		...
		from("direct:getLoanById")
				...
				.to("bean:customJsonMessage?method=logJsonMessage('info', ${header.X-CorrelationId}, " +
						...
						"'Tracking the request', 'Track the response', " +
						"'Request sent to, POST https://{{easy.mambu.host}}/loans/search')")
				.toD("https://{{easy.mambu.host}}/loans/search")
